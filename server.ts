  ...
  app.post("/api/generate", async (req, res) => {
    try {
      ...
      **توجيهات إضافية وتحديد ستايل التصميم:**
      ...
      تنبيه بيداغوجي إجباري لمناهج الجيل الثاني (الجزائر - المقاربة بالكفاءات):
      ...
      ⚠️ **شرط أساسي وجوهري**: يُمنع منعاً باتاً صياغة "الحوصلة" أو "إرساء الموارد" مباشرة دون المرور بمرحلة **"الوضعية التعلمية / النشاط الاستكشافي"**؛ إذ يجب صياغة نص وضعية مشكلة أو نشاط استكشافي كامل بالأسئلة والسندات قبل الاستنتاج والحوصلة في كل المواد (رياضيات، علوم، فيزياء، لغات، إلخ).
      ويجب تكييف أسماء المراحل البيداغوجية وتوزيع الأوقات بالدقائق وجوباً وفق مادة "${teacherInfo?.subject || 'الرياضيات'}" كما هو مفصل في تعليمات النظام أعلاه (مثال للرياضيات: التهيئة 05-10د، الوضعية التعلمية والنشاط 15-20د، الحوصلة وإرساء الموارد 15-20د، وإعادة الاستثمار 10-15د).
