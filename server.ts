    ...
    try {
      ...
      **توجيهات إضافية وتحديد ستايل التصميم:**
      ...
      2️⃣ **جدول سير الدرس البيداغوجي والمحطات الأربعة بالترتيب الإجباري**:
         ...
         • **المرحلة 1: عناصر التهيئة** (05 - 10 دقائق): تقويم تشخيصي، مراجعة المكتسبات القبلية والتهيئة الذهنية.
         • **المرحلة 2: وضعية تعلمية مقترحة** (15 - 20 دقيقة): 
         ...
         • **المرحلة 3: حوصلة** (15 - 20 دقيقة): صياغة النتائج والقواعد والمعارف المستنتجة بخط واضح وبطاقات ملونة.
         • **المرحلة 4: إعادة استثمار** (10 - 15 دقيقة): تطبيق مباشر وتمرين تقويمي لقياس تمكن المتعلم.
      ` : ''}
