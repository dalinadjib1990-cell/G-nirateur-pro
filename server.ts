      ...
      **يجب حتماً وبدون أي استثناء صياغة المذكرة كاملة وفق النموذج الرسمي الجزائري المعتمد** ويتكون وجوباً من:
      ...
      2️⃣ **جدول سير الحصة البيداغوجية الرسمي (Official 4-Column Stages Table)**:
         ...
         • **المرحلة 2: بناء التعلمات** (المدة: 20min - 25min):
           - عمود أنشطة التعلم: يحتوي على عنوان بارز **وضعية تعلمية** (أو نشاط استكشافي) يتضمن:
             * نص وضعية مشكلة تعلمية محفزة وواقعية من الحياة اليومية أو سياق رياضي/علمي.
             * سندات أو رسم/شكل توضيحي بإنلاين SVG نظيف.
             * تعليمات وأسئلة استكشافية متدرجة تحث المتعلم على البحث والتحليل واستنتاج العلاقات قبل الوصول للقاعدة.
           - عمود مؤشرات الكفاءة: مؤشرات بناء التعلم والاستنتاج.
           - عمود التقويم: **تكويني**: مدى دقة المتعلم في استثمار السندات والملاحظة السليمة.
