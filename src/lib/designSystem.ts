...
export const STYLES_REGISTRY: StyleDefinition[] = [
  ...
  // ==========================================================================
  {
    ...
    borderRadius: '14px',
    shadow: '0 16px 36px rgba(11, 37, 69, 0.18), 0 3px 8px rgba(11, 37, 69, 0.08)',
    frameType: 'double_gold',
    palette: ['#0b2545', '#1d4ed8', '#f59e0b', '#38bdf8', '#ffffff'],
    headerStyle: 'board_3d_header',
    footerStyle: 'board_3d_footer',
    artDirection: 'board_3d',
    bgCss: 'radial-gradient(circle at 50% 0%, #f0f7ff 0%, #e2eefb 100%)'
  },
  ...
  // ==========================================================================
  {
    ...
    borderRadius: '12px',
    shadow: '0 10px 28px rgba(194, 65, 12, 0.18)',
    frameType: 'orange_dynamic',
    palette: ['#c2410c', '#ea580c', '#0284c7', '#f59e0b', '#ffffff'],
    headerStyle: 'infographic_hub_header',
    footerStyle: 'infographic_hub_footer',
    artDirection: 'math_infographic',
    bgCss: 'repeating-linear-gradient(0deg, transparent, transparent 19px, #fed7aa 19px, #fed7aa 20px), repeating-linear-gradient(90deg, #fff8ed, #fff8ed 19px, #fed7aa 19px, #fed7aa 20px)'
  },
  ...
  // ==========================================================================
  {
    ...
    borderRadius: '6px',
    shadow: '0 8px 20px rgba(30, 58, 138, 0.16)',
    frameType: 'math_grid',
    palette: ['#1e3a8a', '#0284c7', '#0891b2', '#38bdf8', '#ffffff'],
    headerStyle: 'blueprint_header',
    footerStyle: 'blueprint_footer',
    artDirection: 'blueprint',
    bgCss: 'repeating-linear-gradient(0deg, transparent, transparent 15px, #bae6fd 15px, #bae6fd 16px), repeating-linear-gradient(90deg, #f0f9ff, #f0f9ff 15px, #bae6fd 15px, #bae6fd 16px)'
  },
  ...
  // ==========================================================================
  {
    ...
    borderRadius: '8px',
    shadow: '0 8px 22px rgba(6, 95, 70, 0.14)',
    frameType: 'emerald_ornate',
    palette: ['#065f46', '#047857', '#d97706', '#34d399', '#ffffff'],
    headerStyle: 'textbook_ribbon_header',
    footerStyle: 'textbook_footer',
    artDirection: 'textbook',
    bgCss: 'linear-gradient(180deg, #ffffff 0%, #f4fbf7 100%)'
  },

  // ==========================================================================
  // STYLE 05 — GAMIFIED EDUCATION (التعليم التفاعلي والألعاب)
  ...
  // ==========================================================================
  {
    ...
    headingFont: "'Changa', 'Cairo', sans-serif",
    borderRadius: '14px',
    shadow: '0 10px 28px rgba(185, 28, 28, 0.2)',
    frameType: 'power_banner',
    palette: ['#b91c1c', '#ea580c', '#eab308', '#f87171', '#ffffff'],
  ...
  // ==========================================================================
  {
    ...
    borderRadius: '12px',
    shadow: '0 10px 30px rgba(2, 132, 199, 0.22)',
    frameType: 'tech_hud',
    palette: ['#0284c7', '#4f46e5', '#06b6d4', '#22d3ee', '#ffffff'],
    headerStyle: 'ai_hud_header',
    footerStyle: 'ai_hud_footer',
    artDirection: 'smart_ai',
    bgCss: 'radial-gradient(circle at 100% 0%, #dbeafe 0%, #f0f9ff 60%, #ffffff 100%)'
  },
  ...
  // ==========================================================================
  {
    ...
    borderRadius: '10px',
    shadow: '0 12px 28px rgba(0, 0, 0, 0.12), 0 3px 6px rgba(0, 0, 0, 0.06)',
    frameType: 'cards_modular',
    palette: ['#0284c7', '#eab308', '#c2410c', '#38bdf8', '#ffffff'],
    headerStyle: 'notebook_spiral_header',
    footerStyle: 'notebook_footer',
    artDirection: 'notebook_3d',
    bgCss: 'repeating-linear-gradient(0deg, transparent, transparent 19px, #e2e8f0 19px, #e2e8f0 20px), repeating-linear-gradient(90deg, #fffdf5, #fffdf5 19px, #e2e8f0 19px, #e2e8f0 20px)'
  },
  ...
  // ==========================================================================
  {
    ...
    headingFont: "'Changa', 'Cairo', sans-serif",
    borderRadius: '6px',
    shadow: '0 8px 24px rgba(15, 118, 110, 0.16)',
    frameType: 'side_rail',
    palette: ['#0f766e', '#1d4ed8', '#f59e0b', '#2dd4bf', '#ffffff'],
  ...
  // ==========================================================================
  {
    ...
    headingFont: "'Cairo', 'Changa', sans-serif",
    borderRadius: '18px',
    shadow: '0 12px 30px rgba(109, 40, 217, 0.18)',
    frameType: 'purple_digital',
    palette: ['#6d28d9', '#7c3aed', '#ec4899', '#f472b6', '#ffffff'],
    headerStyle: 'mindmap_hub_header',
    footerStyle: 'mindmap_footer',
    artDirection: 'mind_map',
    bgCss: 'radial-gradient(circle at 50% 30%, #f3e8ff 0%, #faf5ff 60%, #ffffff 100%)'
  },
  ...
  // ==========================================================================
  {
    ...
    headingFont: "'Amiri', 'Cairo', serif",
    borderRadius: '8px',
    shadow: '0 8px 24px rgba(0, 102, 51, 0.16)',
    frameType: 'dz_geometric',
    palette: ['#006633', '#d21034', '#047857', '#eab308', '#ffffff'],
    headerStyle: 'dz_republic_seal_header',
    footerStyle: 'dz_republic_footer',
    artDirection: 'dz_premium',
    bgCss: 'linear-gradient(180deg, #ecfdf5 0%, #ffffff 15%, #ffffff 85%, #ecfdf5 100%)'
  },
  ...
  // ==========================================================================
  {
    ...
    borderRadius: '20px',
    shadow: '0 12px 28px rgba(2, 132, 199, 0.18)',
    frameType: 'kids_playful',
    palette: ['#0284c7', '#f59e0b', '#10b981', '#f43f5e', '#ffffff'],
    headerStyle: 'kids_train_header',
    footerStyle: 'kids_train_footer',
    artDirection: 'kids_creative',
    bgCss: 'linear-gradient(180deg, #e0f2fe 0%, #fffdf5 40%, #ffffff 100%)'
  },
  ...
  // ==========================================================================
  {
    ...
    borderRadius: '10px',
    shadow: '0 12px 32px rgba(9, 13, 22, 0.16)',
    frameType: 'editorial_rules',
    palette: ['#090d16', '#2563eb', '#f59e0b', '#38bdf8', '#ffffff'],
    headerStyle: 'master_poster_header',
    footerStyle: 'master_poster_footer',
    artDirection: 'master_infographic',
    bgCss: 'linear-gradient(180deg, #e2e8f0 0%, #ffffff 10%, #ffffff 90%, #e2e8f0 100%)'
  }
];
